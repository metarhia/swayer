...
export class ReactivityManager {
  ...
  #activateState() {
    ...
    else if (parent?.state) component.state = reactivity.create(parent.state);
  ...
  registerChildren() {
    ...
    // const reaction = (state) => schema.children(state).length;
    // this.#reactivity.register(this.#context.children, 'length', reaction);
