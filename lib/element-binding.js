import { MetacomponentsError } from './core.js';
...
export default class ElementBinding {
  ...
  setRoot() {
    ...
    if (tag === 'html') return root.replaceWith(this.#element);
    const msg = `Root schema is not html, got ${tag}`;
    throw new MetacomponentsError('Schema error', msg);
  }
