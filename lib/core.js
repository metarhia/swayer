...
import { ComponentChildren, Metacomponent } from './metacomponent.js';
...
class ComponentFactory {
  ...
  async createComponent(schema, parent, elementBinding) {
    const component = new Metacomponent(schema, parent, elementBinding);
  ...
  addChildren(parent, parentBinding, initSchemas) {
